...
SELECT name,
       ...
       CASE 
           ...
           WHEN bytes > 1000000 AND bytes < 10000000 THEN '1' 
           ELSE '2' 
       END bytes_cat
  FROM tracks
  ORDER BY bytes_cat;
...
SELECT name,
       bytes,
       IIF(bytes < 1000000, '0',
           IIF(bytes > 1000000 AND bytes < 10000000, '1', '2')) bytes_cat
  FROM tracks
  ORDER BY bytes_cat;-- The iif() function was introduced in SQLite 3.32.0, which was released on 22 May 2020.
